  ...
  return (
    <div className="flex-1 flex flex-col gap-y-8">
      <div className="">
        ...
        <p className="text-sm text-muted-foreground">All of your tickets</p>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center gap-y-4 animate-fade-from-top">
        {ticketData.map((ticket) => (
          ...
          >
            <div className="">
              {TICKET_ICONS[ticket.status as TicketStatus]}
            </div>

            <h3 className="text-xl semibold">{ticket.title}</h3>
            <p
